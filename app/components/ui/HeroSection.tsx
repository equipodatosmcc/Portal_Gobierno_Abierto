...
export function HeroSection() {
  return (
    <section id="inicio" className="relative flex min-h-[90vh] items-center justify-center overflow-hidden">
      ...
      />
      <div aria-hidden="true" className="absolute inset-0 bg-linear-to-b from-black/65 via-black/45 to-primary/85" />
      <div aria-hidden="true" className="absolute inset-0 bg-linear-to-r from-primary/30 via-transparent to-primary/25" />
